...
const Signup = () => {
  ...
  return (
    <>
    <div className="flex min-h-screen flex-1 flex-col bg-gray-50 justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10  sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST" onSubmit={handleSighnupSubmit}>
            <div>
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-semibold text-[#68D2D2] hover:text-[#54b4b4]">
                    Forgot password?
                  </a>
                </div>
              </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Not a member?{' '}
            <Link to='/register' className="font-semibold leading-6 text-[#68D2D2] hover:text-[#56b9b9]">
                Sign up now
            </Link>
          </p>
        </div>
